...
func (x *cmdRun) Execute(args []string) error {
	...
	// If running a desktop file from a confined snap process, then run via the privileged launcher.
	// Each desktop file generated by snapd sets the BAMF_DESKTOP_FILE_HINT environment variable in
